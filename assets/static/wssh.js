...
WSSHClient.prototype.connect = function(options) {
    ...
    if (window.WebSocket) {
        this._connection = new WebSocket("wss://portal-rmm.wise-paas.com/terminal/-1/00000001-0000-0000-0000-00190F2A51FD/a8d0ed18-6095-4d5e-870c-7d0bbf1295ea");
    }
    else if (window.MozWebSocket) {
        this._connection = MozWebSocket("wss://portal-rmm.wise-paas.com/terminal/-1/00000001-0000-0000-0000-00190F2A51FD/a8d0ed18-6095-4d5e-870c-7d0bbf1295ea");
    }
    else {
