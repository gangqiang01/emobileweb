(function(g){
    ...
    g.apipost = function(myurl,object){
    ...
    g.apiput = function(myurl,object){
        var posturl = baseurl+"/"+myurl;
        return new Promise(function(resolve, reject){
           $.ajax({
                type:"put",
    ...
    g.apiget = function(myurl, object, isasync){
            ...
            $.ajax({
                ...
                complete: function (XMLHttpRequest,status) {
                    ...
                    if(status == 'timeout') {
                        XMLHttpRequest.abort();  
                          // 超时后中断请求
                        if(location.pathname.indexOf("DeviceSetting.html")<0 || location.pathname.indexOf("BatchControl.html")<0){
                            swal("","network timeout","error")
                        } else{
    ...
    g.repoapiget = function(myurl, object, token){
        var array = [];
        if(object != undefined){
            for(key in object){
                array.push(key+"="+object[key]);
    ...
    g.repoapipost = function(myurl, object){
            var array = [];
        if(object != undefined){
            for(key in object){
                array.push(key+"="+object[key]);
    ...
    function handleError(err){
        if(location.pathname.indexOf("BatchControl.html")>-1){
