(function(g){
                ...
                function(data){
                    if(data.result){
                        ...
                        if(page != undefined){            
                            ...
                            // 启动设备在线检测
                            // checkOnlineTimer = window.setInterval(function(){CheckOnlineDevice()},7000);
                        }
                    }
                }
            )
    ...
    g.setCookie = function(cname, cvalue, exmins) {
        var d = new Date();
